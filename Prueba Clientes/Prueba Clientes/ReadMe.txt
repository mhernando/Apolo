========================================================================
    APLICACIÓN DE CONSOLA: Prueba Clientes Información general 
    del proyecto
========================================================================

AppWizard ha creado esta aplicación Prueba Clientes.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la Prueba Clientes aplicación.


Prueba Clientes.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado Prueba Clientes.pch y un archivo de 
